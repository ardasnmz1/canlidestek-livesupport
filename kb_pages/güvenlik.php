...
$page_title = "Güvenlik - Bilgi Bankası";

// İlgili makaleleri getir
$stmt = $pdo->prepare("SELECT * FROM kb_articles WHERE category_id = 2 ORDER BY views DESC");
$stmt->execute();
        ...
        <main id="kb-main">
            <div class="kb-page-header">
                ...
                <p class="page-description">
                    Hesap güvenliği ve gizlilik ayarları hakkında önemli bilgiler burada bulunmaktadır.
                    Güvenli kullanım için öneriler ve güvenlik önlemleri hakkında detaylı bilgiler içerir.
                </p>
            </div>

            <div class="kb-page-content">
                <div class="content-section">
                    <h2><i class="fas fa-lock"></i> Güvenlik Önlemleri</h2>
                    <div class="info-cards">
                        <div class="info-card">
                            <i class="fas fa-key"></i>
                            <h3>Güçlü Şifre</h3>
                            <p>Güçlü şifre oluşturma ve yönetimi</p>
                            <a href="#" class="info-link">Detaylı Bilgi</a>
                        </div>
                        <div class="info-card">
                            <i class="fas fa-user-shield"></i>
                            <h3>İki Faktörlü Doğrulama</h3>
                            <p>Ekstra güvenlik katmanı ekleme</p>
                            <a href="#" class="info-link">Detaylı Bilgi</a>
                        </div>
                        <div class="info-card">
                    ...
                    <div class="faq-accordion">
                        <div class="faq-item">
                            ...
                            <div class="faq-answer">
                                Şifrenizi değiştirmek için profil sayfanızdaki "Şifre Değiştir" seçeneğini kullanabilirsiniz.
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-answer">
                                İki faktörlü doğrulama, hesabınıza giriş yaparken şifrenize ek olarak ikinci bir güvenlik
                                katmanı ekler. Bu genellikle telefonunuza gelen bir kod veya doğrulama uygulaması aracılığıyla sağlanır.
                            </div>
                        </div>
                        <div class="faq-item">
                            <div class="faq-question">
